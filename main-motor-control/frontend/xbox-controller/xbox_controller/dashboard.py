    ...
    detail = {
        **summary,
        ...
        "telemetry": {
            ...
            "offset_current_bs": float(getattr(latest_status, "offset_current_bs", 0.0)),
            "offset_current_cs": float(getattr(latest_status, "offset_current_cs", 0.0)),
            "fcl_latency_us": float(getattr(latest_status, "fcl_latency_us", 0.0)),
            "raw_position_offset_pu": float(getattr(latest_status, "raw_position_offset_pu", 0.0)),
            "endat_crc_fail_count": int(getattr(latest_status, "endat_crc_fail_count", 0)),
